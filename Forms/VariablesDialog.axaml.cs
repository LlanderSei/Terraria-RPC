...
public partial class VariablesDialog : Window
{
  ...
  [
    ...
    ("{{PlayerHeldItem}}", "Alias for PlayerItemHeld", "String or empty", "#a5d6a7"),
    ("{{PlayerItemPrefix}}", "Prefix text on the held item", "String or empty", "#a5d6a7"),
    ("{{PlayerHeldItemPrefix}}", "Alias for PlayerItemPrefix", "String or empty", "#a5d6a7"),
    ("{{PlayerHeldItemWikiName}}", "Wiki-safe held item name with spaces replaced by underscores", "String or empty", "#a5d6a7"),
    ("---", "", "", ""),
